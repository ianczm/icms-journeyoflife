...
class ScenarioFiveBCurveball extends Scenario {
    ...
    processAnswer(): void {
        ...
        switch (this.generateCase()) {
            case 1:
                this.character.balanceSheet.cash += -4000;
                ...
                break;
            case 2:
                this.character.balanceSheet.cash += -2000;
                this.character.statusScore += 0;
                this.character.happiness += -0.02;
                ...
                break;
            case 3:
                this.character.balanceSheet.cash += -6000;
