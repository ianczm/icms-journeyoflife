...
class ScenarioFourECurveball extends Scenario {
    ...
    processAnswer(): void {
        ...
        switch (this.generateCase()) {
            case 1:
                this.character.balanceSheet.cash += -36000;
                ...
                break;
            case 2:
                this.character.balanceSheet.cash += -20400;
                this.character.statusScore += 0;
                this.character.happiness += 0;
                ...
                break;
            case 3:
                this.character.balanceSheet.cash += 146400;
                this.character.statusScore += 0;
