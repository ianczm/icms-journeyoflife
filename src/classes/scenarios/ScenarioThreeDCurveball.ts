...
class ScenarioThreeDCurveball extends Scenario {
    ...
    processAnswer(): void {
        ...
        switch (this.generateCase()) {
            case 1:
                this.character.balanceSheet.cash += -11010;
                ...
                break;
            case 2:
                this.character.balanceSheet.cash += -7070;
                this.character.statusScore += 1;
                ...
                break;
            case 3:
                this.character.balanceSheet.cash += -5100;
...
export { ScenarioThreeDCurveball }